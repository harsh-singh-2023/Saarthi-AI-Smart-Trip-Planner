...
import { Sparkles, ArrowLeft, MapPin, Calendar, Hotel, Plane, Mountain, Palmtree } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:block">
                <p className="text-sm text-gray-700">Your AI Travel Companion 🇮🇳</p>
              </div>
            </div>
            {showResults && (
              <Button
                onClick={handleReset}
                className="bg-white brutal-border brutal-shadow hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#1a1a1a] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0px_#1a1a1a] transition-all"
              >
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-5xl mx-auto text-center mb-16">
              <div className="inline-block bg-[#ffe66d] brutal-border px-6 py-2 rotate-[-1deg] mb-6">
                <span className="text-sm">🎉 Discover Incredible India with AI</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-8">
                From the <strong>Himalayas to the beaches of Goa</strong>, from <strong>temples to palaces</strong> 
                - let AI plan your ultimate Indian adventure! 🚀
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                {[
                  { name: 'Taj Mahal', location: 'Agra', img: 'https://images.unsplash.com/photo-1663918455395-49146be36cbb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYSUyMHRhaiUyMG1haGFsJTIwbGFuZG1hcmt8ZW58MXx8fHwxNzYyMTQxNzM0fDA&ixlib=rb-4.1.0&q=80&w=1080' },
                  { name: 'Kerala Backwaters', location: 'Kerala', img: 'https://images.unsplash.com/photo-1680599022555-57fb95b64b5c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrZXJhbGElMjBiYWNrd2F0ZXJzJTIwaW5kaWF8ZW58MXx8fHwxNzYyMDgzMDY0fDA&ixlib=rb-4.1.0&q=80&w=1080' },
                  { name: 'Rajasthan Desert', location: 'Rajasthan', img: 'https://images.unsplash.com/photo-1670687174580-c003b4716959?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyYWphc3RoYW4lMjBkZXNlcnQlMjBjYW1lbHxlbnwxfHx8fDE3NjIxNDE3MzR8MA&ixlib=rb-4.1.0&q=80&w=1080' }
                ].map((dest, index) => (
                  <div
                    key={index}
                    className="brutal-border bg-white overflow-hidden brutal-hover cursor-pointer"
                    style={{ transform: `rotate(${[-1, 0.5, -0.8][index]}deg)` }}
                  >
            ...
            <div className="max-w-6xl mx-auto mt-20">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600">AI-powered features to make your trip unforgettable</p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Day-by-day plans optimized for your preferences',
                    color: '#4ade80',
                    emoji: '📅'
                  },
                  {
                  ...
                  <div
                    ...
                    style={{
                      transform: `rotate(${[-0.5, 1, -1, 0.8, -0.7, 0.5][index]}deg)`,
        ...
        <section className="container mx-auto px-4 py-12 space-y-8">
          ...
          <div className="bg-gradient-to-r from-[#4ade80] to-[#4ecdc4] brutal-border brutal-shadow-lg p-8 text-center rotate-[-0.5deg]">
            <div className="rotate-[0.5deg]">
              <div className="inline-block bg-white brutal-border p-3 mb-4 rotate-3">
                
              </div>
              <h2 className="text-white mb-2">🎉 Trip Plan Generated!</h2>
              <p className="text-white/90 text-xl">
                Your personalized {getDayCount()}-day adventure to <strong>{tripData.destination}</strong> is ready!
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#ff6b6b] to-[#f472b6] brutal-border brutal-shadow-lg p-8 text-center rotate-[0.5deg]">
            <div className="rotate-[-0.5deg]">
              ...
              <p className="text-white/90 mb-6 text-lg">
                Save your itinerary and start booking your journey across Incredible India!
              </p>
      ...
      <footer className="bg-black text-white brutal-border-thick border-b-0 border-l-0 border-r-0 mt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-white/80">
                Your trusted AI companion for exploring the beauty and diversity of India.
              </p>
            </div>
            <div>
          ...
          <div className="border-t-4 border-white pt-6 text-center text-white/80">
            <p>© 2025 Saarthi - AI Smart Trip Planner. Made with ❤️ for India 🇮🇳</p>
            <p className="mt-2 text-sm">
              Currently using mock data. Connect to real APIs for live information.
            </p>
          </div>
        </div>
      </footer>
